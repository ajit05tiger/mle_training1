...
parser.add_argument("--loc_dir", metavar="loc_dir", type=str, help="Input dataset", default="datasets")
parser.add_argument(
    "--pickle_loc",
    metavar="pickle_loc",
    type=str,
...
train_set = pd.read_csv(loc_dir + "/train.csv")
test_set = pd.read_csv(loc_dir + "/test.csv")
strat_train_set = pd.read_csv(loc_dir + "/strat_train.csv")
strat_test_set = pd.read_csv(loc_dir + "/strat_test.csv")
# housing = pd.read_csv(loc_dir + "/housing/housing.csv")
...
housing_prepared.to_csv(os.path.join(loc_dir, "housing_prepared.csv"), index=False)
housing_labels.to_csv(os.path.join(loc_dir, "housing_labels.csv"), index=False)
X_test_prepared.to_csv(os.path.join(loc_dir, "X_test_prepared.csv"), index=False)
y_test.to_csv(os.path.join(loc_dir, "y_test.csv"), index=False)

os.makedirs(pickle_loc, exist_ok=True)
pickle.dump(lin_reg, open(os.path.join(pickle_loc, "lin_reg.pkl"), "wb"))
pickle.dump(tree_reg, open(os.path.join(pickle_loc, "tree_reg.pkl"), "wb"))
